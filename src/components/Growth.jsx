...
const Growth = () => {
    return (
        <section className='growth_section mt-5 mb-5'>
            <Container className='custom_container'>
                ...
                <Row className='align-items-center bg_lightblack rounded-3 mt-5 mx-1'>
                    <Col md={6} className='p-sm-0' data-aos="zoom-in-up"><img className='w-100' src={cartoonImg} alt="cartoonImg" /></Col>
                ...
                <div className="d-flex align-items-center justify-content-between justify-content-sm-around pt-4 mt-2 bg_light_grey">
