...
const Community = () => {
    return (
        <section className='community_section_bgimage mt-5 pt-5 overflow-hidden'>
                    ...
                    <Col lg={8}>
                        <Row>
                            <Col lg={6} className='mt-sm-0 mt-lg-4' data-aos="fade-up-left">
                                <div className='mt-sm-5 cards_shadow p-4 mt-4'>
                                    <h6 className='text-white fs_4md fw-normal ff_helvetica fast_heading position-relative'>Fast</h6>
                                    <p className='text_grey fs_sm fw-normal ff_helvetica mt-2 mb-0 pe-lg-5'>Don’t keep your users waiting. Solana has block times of 400 milliseconds — and as hardware gets faster, so will the network.</p>
                            ...
                            <Col lg={6} data-aos="fade-down-right">
                                <div className='cards_shadow p-4 mt-4'>
                                    <h6 className='text-white fs_4md fw-normal ff_helvetica Decentralized_heading position-relative'>Decentralized</h6>
                                    <p className='text_grey fs_2sm fw-normal ff_helvetica mt-2 mb-0 pe-lg-4'>The Solana network is validated by thousands of nodes that operate independently of each other, ensuring your data remains secure and censorship resistant.</p>
                            ...
                            <Col lg={6} className='mt-lg-4' data-aos="fade-down-left">
                                <div className='cards_shadow p-4 mt-lg-5 mt-4'>
                                    <h6 className='text-white fs_4md fw-normal ff_helvetica Scalable_heading position-relative'>Scalable</h6>
                                    <p className='text_grey fs_2sm fw-normal ff_helvetica mt-2 mb-0 pe-lg-5'>Get big, quick. Solana is made to handle thousands of transactions per second, and fees for both developers and users remain less than $0.01.</p>
                            ...
                            <Col lg={6} data-aos="fade-right">
                                <div className='cards_shadow p-4 mt-4'>
                                    <h6 className='text-white fs_4md fw-normal ff_helvetica Energy_heading position-relative'>Energy Efficient</h6>
                                    <p className='text_grey fs_2sm fw-normal ff_helvetica mt-2 mb-0 pe-lg-5'>Solana’s proof of stake network and other innovations minimize its impact on the <span className='text-success text-decoration-underline'>environment.</span> Each Solana transaction uses about the same energy as a few Google searches.</p>
