...
const MyHeader2 = () => {
    return (
        <section className='overflow-hidden d-flex flex-column align-items-center justify-content-center flex-grow-1 position-relative'>
            <Container className='custom_container'>
                <Row className='flex-column-reverse flex-lg-row align-items-center'>
                    ...
                    <Col sm={8} lg={6} className='position-relative' data-aos="fade-left">
