            ...
            <Container className='custom_container'>
                <Row className='flex-column-reverse flex-lg-row'>
                    <Col lg={6}>
                        ...
                        <a href="#" className='d-inline-block ms-1 ms-sm-2 stack_exchange_btn text-white fs_3xsm fw-normal ff_roboto'>Stack Exchange <svg width="16" height="19" viewBox="0 0 16 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Col lg={6} className='position-relative'>
                        ...
                        <img className='w-100' src={headerImg} alt="v" />
                    </Col>
                </Row>
            </Container>
        </section>
